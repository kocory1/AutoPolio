  ...
  <body>
    ...
    <script>
      ...
      async function loadFilesTreeUI() {
        ...
        // depth/ref 대신 서버 기본값으로 “끝까지(단 traverse_cap=500)” 순회한다.
        ...
        const cappedText = data && data.capped ? ` (cap: ${data.visited_nodes}/${data.traverse_cap})` : '';
        setStatus(`Files Tree 로딩 완료${cappedText}`);
        renderFilesTree();
        renderContentsFileList();
      }
